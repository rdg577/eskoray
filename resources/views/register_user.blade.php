                        ...
                        <div class="form-group{{ $errors->has('user_type') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="user_type">
                                    @if(\Illuminate\Support\Facades\Auth::user()->isSystemAdmin())
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <select name="branch_id" class="form-control">
                                        <option value="{{ \Illuminate\Support\Facades\Auth::user()->branch->id }}">
                                            {{ \Illuminate\Support\Facades\Auth::user()->branch->name }}
                                        </option>
                                    </select>
                                @endif
